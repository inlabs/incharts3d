...
Application.prototype.loadScene = function()
{
    ...
    TextsX.push(new Text(chart.legendX[i]+".0"));
...
Application.prototype.loadTexts = function()
{
    ...
    for(var i=0; i<chart.number_SeriesArray.length; i++)
    {
        ...
        TextsZ.push(new Text(chart.legendZ[i]+".0"));
    }
...
Application.prototype.drawScene= function() 
{
  ...
  //  </editor-fold>
    ...
    for(var i=0; i<Scene.objects.length; i++)
    {
        ...
        {
            mat4.translate(transforms.mvMatrix, [-100+translateX, -14.7-translateY-this.floorStep, -130]);
